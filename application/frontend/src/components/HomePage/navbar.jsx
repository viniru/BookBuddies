...
class Navbar extends Component {
    ...
    render() {
      ...
      const profile = <div className="mx-1">
                      <button className="btn btn-warning" name="User" onClick={this.handleClick}>
      ...
      return (
        <div>
          ...
          {this.state.display.User ? <User u_id={this.state.u_id}/> : null}
